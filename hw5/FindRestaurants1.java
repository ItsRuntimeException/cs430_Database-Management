...
class FindRestaurants1
{
	...
	public static void tryFindRestaurants1(Connection conn) throws SQLException
	{
    	...
    	try 
    	{
			...
			+ " AND a.listing = " +"'"+listing+"'"+ " AND 200 >= (select geo_distance(a.longitude, a.latitude, b.longitude, b.latitude) from dual)";
